...
/**
 * Восстановление оригинальной сетки
 * 
 * @param {Array} gridData - Данные сетки
...
export function restorePortalFlagsOnGrid(save) {
  // Восстановление портала в сокровищницу
  ...
  // Восстановление портала в комнату с алтарём
  ...
  // Восстановление портала в комнату-ловушку
...
export function restoreNotesOnGrid() {
  ...
  for (const [noteIdStr, pos] of Object.entries(state.notes.positions)) {
    ...
    if (notesFound.includes(noteId)) continue;
