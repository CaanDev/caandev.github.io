...
export function restoreMazeData(save) {
  ...
  // Восстаноавление записок на сетке
  restoreNotesOnGrid();
...
export function restorePillarsData(save) {
  ...
  if (save.pillars && Array.isArray(save.pillars)) pillarsData = save.pillars;
  else if (save.secretRoomsData && save.secretRoomsData.pillars) pillarsData = save.secretRoomsData.pillars;
  else if (save.mazeData && save.mazeData.pillars) pillarsData = save.mazeData.pillars;
