...
export function collectPlayerData() {
  return {
    ...
    evasionBonus: player.evasionBonus || 0,
    genderBonuses: player.genderBonuses || {},
    staminaRegenInCombat: player.staminaRegenInCombat || 6,
    staminaRegenOutOfCombat: player.staminaRegenOutOfCombat || 10,
  };
}
