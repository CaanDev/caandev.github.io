...
// Преобразование WEAPONS_DATA в формат, ожидаемый UI
...
// Преобразование ITEMS_DATA в формат снаряжения
...
// Преобразование ITEMS_DATA в формат, ожидаемый UI
// Фильтруются только предметы, не являющиеся снаряжением
for (const [id, data] of Object.entries(ITEMS_DATA)) {
  if (data.type === 'equipment') continue;
