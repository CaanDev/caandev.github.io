/**
 * @fileoverview Взрывы от ловушек.
 * Создаёт эффекты взрывов с частицами, вспышками и тряской экрана.
 * 
 ...
 * 
 * @param {number} x - Координата X центра взрыва (в пикселях)
 * @param {number} y - Координата Y центра взрыва (в пикселях)
 * @param {boolean} [isPlayer=true] - true, если взрыв от игрока (больше частиц и тряска)
 * @returns {void}
 */
