 ...
 * Определяет все достижения, их категории, условия разблокировки и прогресс.
 * 
 ...
 * @description Категории достижений
 */
...
/**
 * @namespace ACHIEVEMENTS_LIST
 * @description Список всех достижений с их параметрами
 */
 ...
 * 
 * @returns {Object} - Объект со всеми достижениями
 */
export const getAchievementsList = () => ACHIEVEMENTS_LIST;

/**
 * Получение достижения по ID
 * 
 * @param {string} id - ID достижения
 * @returns {Object|undefined} - Объект достижения или undefined
 */
export const getAchievement = (id) => ACHIEVEMENTS_LIST[id];

/**
 * Получение достижений по категории
 * 
 * @param {string} categoryId - ID категории
 * @returns {Array} - Массив достижений в категории
 */
export const getAchievementsByCategory = (categoryId) => {
  return Object.values(ACHIEVEMENTS_LIST).filter(a => a.category === categoryId);
};

/**
 * Получение всех достижений в виде массива
 * 
 * @returns {Array} - Массив всех достижений
 */
export const getAllAchievements = () => Object.values(ACHIEVEMENTS_LIST);
 ...
 */
export const getTotalCount = () => Object.keys(ACHIEVEMENTS_LIST).length;