...
/**
 * Отрисовка одной трещины на кэше
 * 
...
function drawSingleCrackOnCache(ctx, dx, dy, seed, cellSize, wallThickness) {
  ...
  // Используется clip только для одной клетки
  ctx.beginPath();
