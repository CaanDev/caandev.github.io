...
export function drawShockSparks(ctx) {
  ...
  if (state.shockSparks.length > 30) state.shockSparks.splice(0, state.shockSparks.length - 30);
}
...
export function drawPoisonBubbles(ctx) {
  ...
  if (state.poisonBubbles.length > 15) state.poisonBubbles.splice(0, state.poisonBubbles.length - 15);
}
