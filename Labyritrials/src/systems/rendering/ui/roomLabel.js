...
export function drawRoomLabel(ctx, canvas) {
  ...
  ctx.font = `200 ${fontSize}px "Oswald", "Comfortaa", "Courier New", monospace`;
  ...
  // Текст - выравнивание по центру с небольшим смещением
  ctx.shadowBlur = 8;
  ctx.shadowColor = color;
  ctx.fillStyle = color;
  ctx.textAlign = 'center';
  ctx.textBaseline = 'middle';
  ctx.fillText(text, canvas.width / 2, y + bgHeight / 2 + 2);
