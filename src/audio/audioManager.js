...
class AudioManager {
  ...
  updateMusicByLocation() {
    ...
    if (state.inSafeRoom) mode = 'safeRoom';
    else if (state.inTreasureRoom || state.inShrineRoom || state.inTrapRoom) mode = 'game';

    if (this.music.isEnabled) this.forcePlayMusic(mode); else this.music.setMode(mode);
  }
  ...
  forcePlayMusic(mode) {
    ...
    if (this.music.isEnabled) this.music.play(mode);
  }
  ...
  resume() {
    ...
    if (this.isGameActive && this.music.isEnabled) this.music.resume();
    else if (this.isMainMenu && this.music.isEnabled) this.music.resume();
  }
  ...
  setMusicEnabled(enabled) {
    ...
    if (enabled && this.isGameActive) this.updateMusicByLocation();
  }
