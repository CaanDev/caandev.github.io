...
export function checkAdaptations() {
  for (let key in ADAPTATIONS) {
    ...
    if (total > threshold && !adaptation.isActive()) adaptation.apply();
  }
}
...
export function resetAdaptations() {
  ...
  // Восстановление HP монстров, которые были усилены адаптацией "Закалка"
